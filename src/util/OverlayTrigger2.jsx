/** 
 * Modified from the original to prevent popovers from going beyond
...
var OverlayTrigger = React.createClass({
  ...
  render: function () {
    ...
    if (isOneOf('hover', this.props.trigger)) {
      props.onMouseOver = createChainedFunction(
              this.handleDelayedShow, this.props.onMouseOver);
      props.onMouseOut = createChainedFunction(
              this.handleDelayedHide, this.props.onMouseOut);
    }
  ...
  updateOverlayPosition: function () {
    ...
    this.setState({
      ...
      overlayTop: pos.top,
      arrowOffsetLeft: pos.arrowOffsetLeft
    });
  },
  ...
  calcOverlayPosition: function () {
    ...
    if (overlayNode.children.length && overlayNode.className.indexOf("zHACK") !== -1) {
        overlayNode = overlayNode.children[0];
    }
    ...
    switch (this.props.placement) {
      ...
      case 'bottom':
        var preferredOffset = childOffset.left + childOffset.width / 2 - overlayWidth / 2;
        var offset = Math.max(20, preferredOffset);
        return {
          top: childOffset.top + childOffset.height,
          left: offset,
          arrowOffsetLeft: (preferredOffset - offset) + overlayWidth/2
        };
      default:
        throw new Error('calcOverlayPosition(): No such placement of "' +
