...
var Context = (function () {
    ...
    Context.prototype._annotateImpl = function (from, cursor, disableRecordings) {
        ...
        var verbose = false;
        var stopIn = NaN;
        for (var it = new Priv.MultiIterator(this, from, this._voices, cursor, this._assertionPolicy); !it.atEnd; it.next(status)) {
...
(function (Priv) {
    ...
    Priv._cpysnapshot = _cpysnapshot;
    var MultiIterator = (function () {
        function MultiIterator(parent, from, voices, cursor, assertionPolicy) {
        ...
        MultiIterator.prototype.annotate = function (verbose) {
            this._assertOffsetsOK();
        ...
        MultiIterator.prototype.next = function (status) {
            switch (status) {
                case 10 /* Success */:
                    this._increment();
                    break;
        ...
        Object.defineProperty(MultiIterator.prototype, "atEnd", {
            get: function () {
                for (var i = 0; i < this._components.length; ++i) {
        ...
        MultiIterator.prototype._assertOffsetsOK = function () {
            if (this._assertionPolicy === 1 /* NoAssertions */) {
                return;
            }
        ...
        MultiIterator.prototype._componentWithPriority = function (type) {
            for (var i = 0; i < this._components.length; ++i) {
        ...
        MultiIterator.prototype._rewindTwoNewlines = function () {
            for (var i = 0; i < this._components.length; ++i) {
        ...
        MultiIterator.prototype._ensureCurrPrioritiesMatch = function () {
        ...
        MultiIterator.prototype._clearCursor = function () {
        ...
        MultiIterator.prototype._markLineDirty = function () {
    ...
    Priv.MultiIterator = MultiIterator;
    var Iterator = (function () {
        function Iterator(from, voice, idx, cursor, part, indexInPart, assertionPolicy) {
            this._division = null;
        ...
        Iterator.prototype.annotate = function (ctx, canExitAtNewline) {
        ...
        Iterator.prototype.rewind = function (priority) {
            if (!priority) {
                --this._idx;
            }
            else {
        ...
        Iterator.prototype.rewindSeek = function (loc, priority) {
        ...
        Iterator.prototype._updateSubctx = function () {
        ...
        Iterator.prototype.trySeek = function (priority) {
            this.ensurePriorityIs(priority);
            ++this._idx;
            assert(this.nextPriority === C.MAX_NUM || this.curr);
        };
        Iterator.prototype.ensurePriorityIs = function (priority) {
            if (this._assertionPolicy === 0 /* Strict */) {
        ...
        Iterator.prototype.lastOf = function (priority) {
            var i = this._idx;
        ...
        Object.defineProperty(Iterator.prototype, "nextLocation", {
            get: function () {
                var next = this._next;
        ...
        Object.defineProperty(Iterator.prototype, "nextPriority", {
            get: function () {
                var next = this._next;
        ...
        Object.defineProperty(Iterator.prototype, "atEnd", {
            get: function () {
        ...
        Object.defineProperty(Iterator.prototype, "curr", {
            get: function () {
                return this._body[this._idx];
            },
            enumerable: true,
        ...
        Object.defineProperty(Iterator.prototype, "len", {
            get: function () {
        ...
        Iterator.prototype._beatExceedsContext = function (ctx) {
        ...
        Iterator.prototype._addPadding = function (ctx) {
            var PlaceholderModel = require("./placeholder");
        ...
        Object.defineProperty(Iterator.prototype, "_next", {
            get: function () {
        ...
        Iterator.prototype._shouldUpdateVC = function (ctx) {
            if (!this._cursor) {
                return false;
            }
            if (!ctx.curr) {
        ...
        Object.defineProperty(Iterator.prototype, "_body", {
            get: function () {
