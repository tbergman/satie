...
var NewlineView = (function (_super) {
    ...
    NewlineView.prototype.render = function () {
        ...
        return React.createElement("g", null, React.createElement(StaveLines.Component, { key: "StaveLines", width: this.props.spec.staveW, x: spec.x, y: spec.braceY }), React.createElement(BarNumber.Component, { x: spec.x - 0, y: spec.braceY - 30, barNumber: barNumber }));
    };
    return NewlineView;
